...
#define DATE "built on: Mon Oct  5 12:29:45 2020 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','h','o','m','e','/','l','e','o','n',
    'e','/','æ','–','‡','æ','¡','£','/','l','i','n','u','x','-','s',
    'g','x','/','e','x','t','e','r','n','a','l','/','d','c','a','p',
    '_','s','o','u','r','c','e','/','Q','u','o','t','e','V','e','r',
    'i','f','i','c','a','t','i','o','n','/','s','g','x','s','s','l',
